...
class CreateRecipeReviewViewTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.url = reverse('recipe_reviews', kwargs={'pk': self.recipe.pk})
    ...
    def test_reviews_page_url(self):
        self.assertEqual(self.url, f'/recipes/{self.recipe.pk}/reviews/')
    
    def test_get_reviews_page_allowed(self):
