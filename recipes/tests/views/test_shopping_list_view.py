...
from recipes.models.recipe import Recipe, RecipeIngredient, RecipeInstruction
...
class ShoppingListViewTests(TestCase):
    ...
    def test_aggregates_ingredients_same_name_unit(self):
        ...
        RecipeInstruction.objects.create(recipe=recipe1, text="Step 1")
        ...
        RecipeInstruction.objects.create(recipe=recipe2, text="Step 1")
    ...
    def test_only_uses_saved_recipes(self):
        ...
        RecipeInstruction.objects.create(recipe=saved_recipe, text="Step 1")

        # Fixed Unsaved Recipe
        ...
        RecipeInstruction.objects.create(recipe=unsaved_recipe, text="Step 1")
