...
class UserProfileViewTestCase(TestCase, LogInTester):
    ...
    def test_recipe_count_correct(self):
        ...
        RecipeInstruction.objects.create(recipe=r1, text='Test instruction 1')
        ...
        RecipeInstruction.objects.create(recipe=r2, text='Test instruction 2')
    ...
    def test_user_recipes_in_context(self):
        ...
        RecipeInstruction.objects.create(recipe=recipe, text='Test instruction')
